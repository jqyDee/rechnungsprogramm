...
class KgRechnung(PDF):
    ...
    def create_pages(self, filepath):
        ...
        self.add_font("Arial", "", "./system/components/fonts/Arial.ttf")
        self.add_page()
        ...
        with self.table(
            ...
            for data_row in self.table_data_3:
                ...
                for index, datum in enumerate(data_row):
                    if index == 4:
                        self.set_font("Arial", size=self.honorar_font_size + 1)
                        row.cell(datum)
                        self.set_font(
        ...
        self.ln(0)
        self.set_font("helvetica", size=self.normal_font_size)
        self.write(6.5, text=f"Ich bitte Sie, den Gesamtbetrag von {self.gesamtpreis} Euro "
...
class HpRechnung(PDF):
    ...
    def create_pages(self, filepath):
        ...
        #                     for index, datum in enumerate(data_row):
        #                         if index == 4:
        #                             dummy.set_font("Arial", size=self.honorar_font_size + 1)
        #                             row.cell(datum)
        #                             dummy.set_font(
        #                                 "helvetica", style="", size=self.honorar_font_size
        #                             )
        ...
        #                             if index == 4:
        #                                 dummy.set_font(
        #                                     "Arial", "", size=self.honorar_font_size + 1
        #                                 )
        #                                 row.cell(datum)
        #                                 dummy.set_font(
        #                                     "helvetica", style="", size=self.honorar_font_size
        ...
        with self.offset_rendering() as dummy:
            dummy.write(6.5, text=f"Ich bitte Sie, den Gesamtbetrag von {self.gesamtpreis} Euro "
                                  f"innerhalb von 14 Tagen unter Angabe der Rechnungsnummer auf "
                                  f"unten stehendes Konto zu überweisen.")
            dummy.ln(13)
