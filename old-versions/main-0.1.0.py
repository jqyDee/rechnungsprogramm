...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.title("Rechnungsprogramm 2023 - Mervi Kristina Fischbach")
        ...
        self.sidebar_label_2 = customtkinter.CTkLabel(self.sidebar_frame, text="2023",
    ...
    def sidebar_button_neue_rechnung_event(self):
        ...
        self.sidebar_button_neue_rechnung.configure(state="disabled")
        self.sidebar_button_stammdaten.configure(state="enabled")
        self.sidebar_button_rechnung_loeschen.configure(state="enabled")
    ...
    def sidebar_button_stammdaten_event(self):
        # configure disabled Buttons
        self.sidebar_button_neue_rechnung.configure(state="enabled")
        self.sidebar_button_stammdaten.configure(state="disabled")
        self.sidebar_button_rechnung_loeschen.configure(state="enabled")
    ...
    def sidebar_button_rechnung_loeschen_event(self):
        ...
        self.sidebar_button_neue_rechnung.configure(state="enabled")
        self.sidebar_button_stammdaten.configure(state="enabled")
        self.sidebar_button_rechnung_loeschen.configure(state="disabled")
        ...
        self.rechnung_loeschen_error_msg = customtkinter.CTkLabel(self.rechnungsnummer_frame, text="")
    ...
    def kuerzel_neue_rechnung_keystroke_check_event(self, t):
        ...
        if os.path.exists("D:\\Programming\\Mervi-Rechnungsprogramm\\Stammdaten\\" + entry + ".txt"):
            logging.info("stammdatei exists")
            with open("D:\\Programming\\Mervi-Rechnungsprogramm\\Stammdaten\\" + entry + ".txt", "r") as f:
    ...
    def pdf_erstellen(self, rechnungsnummer, datum, stammdaten, daten_liste, datenzahl,
        ...
        os.path.isfile(
            "D:\\Programming\\Mervi-Rechnungsprogramm\\Rechnungen\\Rechnungen2023\\" + rechnungsnummer + ".pdf")
        my_file = Path(
            "D:\\Programming\\Mervi-Rechnungsprogramm\\Rechnungen\\Rechnungen2023\\" + rechnungsnummer + ".pdf")
        ...
        # PDF Speichern
        pdf.ln(100)
        pdf.output("D:\\Programming\\Mervi-Rechnungsprogramm\\Rechnungen\\Rechnungen2023\\" + rechnungsnummer + ".pdf")
    ...
    def store_data(self, rechnungsnummer, datum, stammdaten, daten_liste, datenzahl, behandlungsarten_bezeichnung_liste,
        ...
        os.path.isfile(
            "D:\\Programming\\Mervi-Rechnungsprogramm\\Rechnungen\\ZusammenfassungRechnungen\\RechnungenInsgesamt2023.txt")
        my_file = Path(
            "D:\\Programming\\Mervi-Rechnungsprogramm\\Rechnungen\\ZusammenfassungRechnungen\\RechnungenInsgesamt2023.txt")
        if my_file.exists():
            open_file = open(
    ...
    def kuerzel_stammdaten_keystroke_check_event(self, t):
        ...
        if len(entry) == 4:
            ...
            elif not os.path.exists("D:\\Programming\\Mervi-Rechnungsprogramm\\Stammdaten\\" + entry + ".txt"):
                self.kuerzel_entry.configure(text_color="red")
    ...
    def stammdaten_abschicken_button_event(self):
        with open('D:\\Programming\\Mervi-Rechnungsprogramm\\Stammdaten\\' + str(
    ...
    def rechnung_loeschen_abschicken_button_event(self):
        ...
        if entry == "":
            ...
            self.rechnung_loeschen_error_msg.grid_forget()
    ...
    def rechnung_loeschen_bestaetigen_button_event(self):
        ...
        deleted_lines = 0
        rechnung_exists = os.path.exists("D:\\Programming\\Mervi-Rechnungsprogramm\\Rechnungen\\Rechnungen2023\\" + entry + ".pdf")
        ...
        if deleted_lines == 0 or not rechnung_exists:
            ...
            os.remove("D:\\Programming\\Mervi-Rechnungsprogramm\\Rechnungen\\Rechnungen2023\\" + entry + ".pdf")

            # removing line out of RechnungenInsgesamt
            for line in fileinput.FileInput("D:\\Programming\\Mervi-Rechnungsprogramm\\Rechnungen\\ZusammenfassungRechnungen\\RechnungenInsgesamt2023.txt",
                                        inplace=True):
                if entry in line:
                    print("", end="")
                    continue
    ...
    def info_message(self, frame, error_msg, color, remove_elements=None):
        ...
        if frame == "rechnung_löschen":
            self.rechnung_loeschen_error_msg.configure(text=error_msg, text_color=color)
            self.rechnung_loeschen_error_msg.grid(row=1, column=0, padx=20, pady=5)
